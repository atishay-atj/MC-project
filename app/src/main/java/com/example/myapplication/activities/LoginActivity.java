...
//                                     startActivity(intent);
                                    Log.d("adarsh", "commented calling MainActivity");
                                    Bundle bundle = new Bundle();
                                    ...
                                    if (phonetxt.equals("77777")/*adminDB.hasChild(phonetxt)*/) {
                                        Log.d("adarsh", "calling vendorhomepageactivity");
                                        Intent intent_vhp = new Intent(LoginActivity.this, VendorHomePageActivity.class);
                                        ...
                                        vfragmentTransaction.replace(R.id.constraint1, firstVendorFragment);
...
//            Bundle bundle = new Bundle();
                                        ...
                                        Log.d("adarsh", " calling MainActivity");
                                        Intent intent = new Intent(LoginActivity.this, MainActivity.class);
                                        startActivity(intent);
                                    }
                                } else {
